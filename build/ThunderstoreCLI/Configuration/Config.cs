 ...
 * https://github.com/thunderstore-io/thunderstore-cli/blob/10b73c843f2dd1a9ed9c6cb687dbbaa555626052/ThunderstoreCLI/Configuration/Config.cs
...
public class Config
{
    ...
    private readonly Lazy<ApiHelper> _api;
    public ApiHelper Api => _api.Value;

    private Config()
    {
        _api = new Lazy<ApiHelper>(() => new ApiHelper(this));
    }
